    ...
    render() {
        return (
            <View style={styles.container}>
                <Image
                    source={require("../assets/images/background/Peach.jpg")}
                    style={{
                        width: 400,
                        height: 350,
                    }} />
                ...
                <View style={styles.infortag}>
                    ...
                    <View style={styles.topic}>
                        ...
                        <Image
                            style={styles.image}
                            source={{
                                uri: 'http://143.244.179.77/peach_temp.png',
                            }}
                        />
                    ...
                    <View style={styles.topic}>
                        ...
                        <Image
                            style={styles.wind}
                            source={{
                                uri: 'http://143.244.179.77/peach_wind.png',
                            }}
                        />
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('History')}>
                    ...
                    <View style={styles.topic}>
                        ...
                        <Image
                            style={styles.image}
                            source={{
                                uri: 'http://143.244.179.77/peach_moisture.png',
                            }}
                        />
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('History')}>
